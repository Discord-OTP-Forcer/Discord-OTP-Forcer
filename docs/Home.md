<h1 align="center">Discord OTP Forcer Wiki</h1>

<p align="center"><b>This wiki should have all the information you need to setup and run the Discord OTP Forcer</b></p>

---

Instructions on how to setup and use this program can now be found on the [new documentation site](https://discord-otp-forcer.codeberg.page/en/user/setup/). You can still use this wiki though - just click on the Page button at the top. 
...
- Avoids rate limiting with a configurable cool-down between each code attempt
